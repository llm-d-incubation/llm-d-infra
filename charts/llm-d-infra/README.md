...
- [kGateway](https://kgateway.dev/) (or [Istio](http://istio.io/)) installed in the cluster (see for [examples](https://github.com/llm-d-incubation/llm-d-infra/blob/main/quickstart/gateway-control-plane-providers/istio.helmfile.yaml) we use in our CI)
